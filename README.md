...
│   ├── seq2seq/                   # Imported from the vibe-cooking-main project
...
├── seq2seq_checkpoints/best.pt    # Trained Seq2Seq weights
...
| `seq2seq_checkpoints/best.pt` | ~30 MB | Trained Seq2Seq weights |
...
- Seq2Seq: trained in-house; checkpoint bundled at `seq2seq_checkpoints/best.pt`
