"""Tests for the local AllRecipes parser + retriever used by the SEQ2SEQ path."""

from src.seq2seq.allrecipes import ParsedRecipe, parse_recipe_blob, retrieve_recipes
